BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:9753: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1530: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:6506: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:7679: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1455: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:6803: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:3111: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:4461: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:2378: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1784: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1730: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:6256: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:8898: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:7195: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1799: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1090: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:8399: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:4142: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1631: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:5879: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:2386: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:7434: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:906: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:6440: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:2069: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1573: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
BdJFOUHjhjrQVdbhZdbUlJaDo:8588: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:5700: attempt to perform arithmetic (pow) on string and number
BdJFOUHjhjrQVdbhZdbUlJaDo:1: attempt to perform arithmetic (pow) on string and number
1
--[[
...
APIRef.Update = function()
	KeybindFrame:SetName(APIRef.Keybind and (APIRef.Name.." ["..tostring(APIRef.Keybind).."]") or APIRef.Name);
...
APIRef.Thread = task.spawn(function()
	while true do task.wait(0.01)
		if APIRef.Mode ~= 1 and APIRef.Keybind then
...
function Compkiller:_LoadElement(Parent: Frame , EnabledLine: boolean , Signal , DisableStackKeybind)
	...
	function Args:AddToggle(Config : Toggle)
		...
		Args.Flag = Config.Flag;
		Args.Root = Block.Root; -- Expose Root for ShowWhenEnabled functionality
		
		-- Table to store elements that should be shown/hidden based on toggle state
		-- Format: {element = element, root = rootElement, originalSize = size}
		local DependentElements = {};
		local Tween = TweenInfo.new(0.3, Enum.EasingStyle.Quint);
		
		-- Track animation state to prevent conflicts
		-- Store pending delay threads per element to properly cancel them
		local pendingDelayThreads = {}; -- Map of rootElement -> thread
		local currentToggleState = Config.Default; -- Track the actual toggle state

		-- Function to update visibility of all dependent elements with fade animation
		local function UpdateDependentElements(isEnabled)
			-- If no dependent elements, nothing to do
			if #DependentElements == 0 then
				return;
			end
			
			-- Update current state
			currentToggleState = isEnabled;
			
			-- Cancel ALL pending delay threads first (critical for spam prevention)
			for rootElement, thread in pairs(pendingDelayThreads) do
				if thread then
					task.cancel(thread);
				end
			end
			pendingDelayThreads = {}; -- Clear all threads
			
			for _, data in ipairs(DependentElements) do
				if not data or not data.element then continue end
				
				local rootElement = data.root
				if not rootElement then continue end
				
				-- Immediately set correct state to prevent race conditions
				-- If toggle is enabled, ensure element is visible
				-- If toggle is disabled, ensure element will be hidden
				if isEnabled then
					-- FADE IN: Show element via transparency only
					rootElement.Visible = true
					rootElement.Size = data.originalSize -- Keep original size, no size animation
					
					-- Fade in all visual elements via transparency
					for _, child in ipairs(rootElement:GetDescendants()) do
						if child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
							-- Store original transparency once (before we override it)
							local originalTrans = child:GetAttribute("OriginalTextTrans")
							if originalTrans == nil then
								originalTrans = child.TextTransparency
								child:SetAttribute("OriginalTextTrans", originalTrans)
							end
							-- Start fully transparent then tween back to original
							child.TextTransparency = 1
							Compkiller:_Animation(child, Tween, {
								TextTransparency = originalTrans
							})
						elseif child:IsA("UIStroke") then
							child.Transparency = 1 -- Start fully transparent
							Compkiller:_Animation(child, Tween, {
								Transparency = 0
							})
						elseif child:IsA("Frame") or child:IsA("ImageButton") or child:IsA("ImageLabel") then
							-- Store original background transparency once
							local originalBG = child:GetAttribute("OriginalBGTrans")
							if originalBG == nil then
								originalBG = child.BackgroundTransparency
								child:SetAttribute("OriginalBGTrans", originalBG)
							end
							...
							-- Image transparency for image elements
							if child:IsA("ImageLabel") or child:IsA("ImageButton") then
								local originalImage = child:GetAttribute("OriginalImageTrans")
								if originalImage == nil then
									originalImage = child.ImageTransparency
									child:SetAttribute("OriginalImageTrans", originalImage)
								end

								child.ImageTransparency = 1
								Compkiller:_Animation(child, Tween, {
									ImageTransparency = originalImage
								})
							end
						end
					end
				else
					-- FADE OUT: Hide element via transparency only
					-- Fade out all visual elements
					for _, child in ipairs(rootElement:GetDescendants()) do
						if child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
							if not child:GetAttribute("OriginalTextTrans") then
								child:SetAttribute("OriginalTextTrans", child.TextTransparency)
							end
							Compkiller:_Animation(child, Tween, {
								TextTransparency = 1
							})
						...
						elseif child:IsA("Frame") or child:IsA("ImageButton") or child:IsA("ImageLabel") then
							if child.BackgroundTransparency ~= 1 then
								if not child:GetAttribute("OriginalBGTrans") then
									child:SetAttribute("OriginalBGTrans", child.BackgroundTransparency)
								end
								Compkiller:_Animation(child, Tween, {
									BackgroundTransparency = 1
								})
							...
							if child:IsA("ImageLabel") or child:IsA("ImageButton") then
								if not child:GetAttribute("OriginalImageTrans") then
									child:SetAttribute("OriginalImageTrans", child.ImageTransparency)
								end
								Compkiller:_Animation(child, Tween, {
									ImageTransparency = 1
								})
					...
					-- Hide after fade completes - store thread per element
					local delayThread = task.delay(0.3, function()
						-- Double-check toggle state hasn't changed (prevent race condition)
						if rootElement and currentToggleState == false then
							rootElement.Visible = false
							rootElement.Size = UDim2.new(1, 0, 0, 0) -- Set to 0 after hidden for section resize
						end
						-- Remove from pending threads
						pendingDelayThreads[rootElement] = nil;
					end)
					pendingDelayThreads[rootElement] = delayThread;
				end
			end
		end;
		...
		local debounceTime = 0.1; -- 100ms debounce to prevent spam issues
		local isProcessingClick = false; -- Prevent concurrent processing
		
		Toggle.Input.MouseButton1Click:Connect(function()
			local currentTime = tick();
			
			-- Prevent rapid clicks and concurrent processing
			if isProcessingClick or (currentTime - lastClickTime < debounceTime) then
				return;
			end
			...
			Config.Default = not Config.Default;
			currentToggleState = Config.Default; -- Update tracked state immediately
			...
			-- Update dependent elements visibility (will handle animation state internally)
			UpdateDependentElements(Config.Default);
		...
		-- Method to add elements that should be shown when toggle is enabled
		-- You can pass multiple elements: ShowWhenEnabled(toggle1, toggle2, slider1)
		-- Or pass a table: ShowWhenEnabled({toggle1, toggle2, slider1})
		-- Or chain calls: ShowWhenEnabled(toggle1):ShowWhenEnabled(toggle2)
		function Args:ShowWhenEnabled(...)
			local elements = {...};
			
			-- If first argument is a table (array), use that instead
			-- Check if it's an array table (has numeric indices) vs object table
			if #elements == 1 and typeof(elements[1]) == "table" then
				local firstArg = elements[1];
				-- Check if it's an array (has numeric keys) and not an element object (has Root property)
				if #firstArg > 0 and not firstArg.Root then
					elements = firstArg;
				end;
			end;
			...
			for _, element in ipairs(elements) do
				if element then
					-- Get root element and store original size
					...
					if typeof(element) == "table" then
						if element.Root and element.Root:IsA("GuiObject") then
							...
							originalSize = rootElement.Size
						end
					elseif typeof(element) == "Instance" and element:IsA("GuiObject") then
						rootElement = element
						originalSize = rootElement.Size
					end
					
					if rootElement then
						table.insert(DependentElements, {
							element = element,
							root = rootElement,
							originalSize = originalSize
						});
						
						-- If toggle starts OFF, immediately hide element (no animation)
						-- This prevents elements from taking up space initially
						if not Config.Default then
							rootElement.Visible = false
							rootElement.Size = UDim2.new(1, 0, 0, 0)
							-- Set all children to fully transparent
							for _, child in ipairs(rootElement:GetDescendants()) do
								if child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
									child:SetAttribute("OriginalTextTrans", child.TextTransparency)
									child.TextTransparency = 1
			...
			-- Use task.wait to ensure elements are fully initialized
			task.spawn(function()
				task.wait() -- Wait one frame to ensure elements are created
				-- Only animate if toggle is ON, otherwise already hidden
		...
		function Args:SetValue(value)
			-- Update tracked state immediately to prevent race conditions
			currentToggleState = value;
			
			-- Don't block SetValue - allow programmatic changes
			-- Animation state will be handled by UpdateDependentElements
			...
			-- Update dependent elements visibility
			UpdateDependentElements(Config.Default);
		end;
	...
	function Args:AddColorPicker(Config: ColorPicker)
		...
		-- Add Root property for ShowWhenEnabled functionality
		Args.Root = Block.Root;
	...
	function Args:AddSlider(Config: Slider)
		...
		-- Click-to-edit functionality for slider value
		local ValueTextBox = nil;
		local isEditing = false;
		local escapeConnection = nil;
		
		-- Define StopEditing first so it's available when StartEditing uses it
		local function StopEditing(applyValue)
			if not isEditing or not ValueTextBox then return end;
			...
			if applyValue and ValueTextBox then
				-- Parse and validate input
				local inputText = ValueTextBox.Text:gsub(Config.Type, ""):match("^%s*(.-)%s*$"); -- Remove type suffix and trim
				local numValue = tonumber(inputText);
				
				if numValue then
					-- Clamp value to min/max
					numValue = math.clamp(numValue, Config.Min, Config.Max);
					
					-- Round if needed
					if Config.Round > 0 then
						numValue = math.floor((numValue * (10 ^ Config.Round)) + 0.5) / (10 ^ Config.Round);
					else
						numValue = math.floor(numValue + 0.5);
					end;
					
					-- Update slider value
					Config.Default = numValue;
					ValueText.Text = tostring(Config.Default)..tostring(Config.Type);
					
					-- Update slider visual
					local Size = (Config.Default - Config.Min) / (Config.Max - Config.Min);
			...
			if ValueTextBox then
				ValueTextBox:Destroy();
				ValueTextBox = nil;
			end;
		end;
		
		-- Now define StartEditing after StopEditing so it can use StopEditing
		local function StartEditing()
			if isEditing or not Signal:GetValue() then return end;
			
			isEditing = true;
			
			-- Create TextBox overlay
			ValueTextBox = Instance.new("TextBox");
			ValueTextBox.Name = Compkiller:_RandomString();
			ValueTextBox.Parent = ValueText.Parent;
			ValueTextBox.AnchorPoint = ValueText.AnchorPoint;
			ValueTextBox.Position = ValueText.Position;
			ValueTextBox.Size = ValueText.Size;
			ValueTextBox.ZIndex = ValueText.ZIndex + 1;
			ValueTextBox.BackgroundTransparency = 1;
			ValueTextBox.BorderSizePixel = 0;
			ValueTextBox.Font = ValueText.Font;
			ValueTextBox.TextSize = ValueText.TextSize;
			ValueTextBox.TextColor3 = ValueText.TextColor3;
			ValueTextBox.TextXAlignment = Enum.TextXAlignment.Right;
			ValueTextBox.Text = tostring(Config.Default);
			ValueTextBox.ClearTextOnFocus = false;
			ValueTextBox.TextTransparency = ValueText.TextTransparency;
			
			-- Store original text color for hover effect
			local originalTextColor = ValueText.TextColor3;
			
			-- Add to color system
			table.insert(Compkiller.Elements.SwitchColor, {
				Element = ValueTextBox,
				Property = 'TextColor3'
			});
			
			-- Hover effect - subtle highlight
			Compkiller:_Hover(ValueTextBox, function()
				-- Hover in - subtle highlight
				if ValueTextBox and ValueTextBox.Parent then
					Compkiller:_Animation(ValueTextBox, TweenInfo.new(0.2), {
						TextColor3 = Compkiller.Colors.Highlight
					});
				end;
			end, function()
				-- Hover out - back to original
				if ValueTextBox and ValueTextBox.Parent then
					Compkiller:_Animation(ValueTextBox, TweenInfo.new(0.2), {
			...
			if ValueTextBox then
				ValueTextBox.FocusLost:Connect(function(enterPressed)
					if ValueTextBox and ValueTextBox.Parent then
						StopEditing(true); -- Apply value when focus is lost
					end;
				end);
			end;
			...
			escapeConnection = UserInputService.InputBegan:Connect(function(input, gameProcessed)
				...
				if input.KeyCode == Enum.KeyCode.Escape and ValueTextBox and ValueTextBox.Parent and ValueTextBox:IsFocused() then
					StopEditing(false); -- Cancel without applying
				end;
			end);
			
			-- Focus the TextBox and select text manually (SelectAll doesn't exist in Roblox)
			task.spawn(function()
				task.wait(0.1);
				if ValueTextBox and ValueTextBox.Parent then
					ValueTextBox:CaptureFocus();
					task.wait(0.05);
					-- Manually select all text by setting cursor to end and selecting from start
					if ValueTextBox and ValueTextBox.Parent then
						ValueTextBox.CursorPosition = #ValueTextBox.Text + 1;
						ValueTextBox.SelectionStart = 1;
					end;
				end;
			end);
		end;
		
		-- Click on ValueText to edit (works for both mouse and touch)
		Compkiller:_Input(ValueText, function()
			StartEditing();
		end);
		
		-- Mobile support: Also allow tap on ValueText
		if Compkiller:_IsMobile() then
			ValueText.InputBegan:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.Touch and not isEditing then
					StartEditing();
				end;
			end);
		end;
...
function Compkiller:Loader(IconId,Duration)
    ...
    FadeInWindow = function(self, Window)
        Event.Event:Wait();
        if not Window then return end;

        local Screen = Window.Root;
        ...
        local MainFrame = Screen:FindFirstChildWhichIsA("Frame");
        if MainFrame then
            MainFrame.BackgroundTransparency = 1;
            
            Compkiller:_Animation(MainFrame, TweenInfo.new(0.8, Enum.EasingStyle.Quint), {
                BackgroundTransparency = 0
            });
        end;
...
ERROR: Unable to assign property Text. Provided string length (340945) is greater than or equal to max length (200000)

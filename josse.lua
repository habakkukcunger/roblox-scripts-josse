...
-- Checks both standard PlayerGui and CoreGui for an existing instance
if PlayerGui:FindFirstChild("VBLegendsHub") or CoreGui:FindFirstChild("VBLegendsHub") then
    print("josserpopsier Hub is already running! Execution stopped to prevent clutter.")
    return -- Instantly terminates the script execution right here
end
...
UI.Name = "VBLegendsHub" -- Matches the guard check name perfectly
